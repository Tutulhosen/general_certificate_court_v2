                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="case_no" class="control-label"><span style="color:#FF0000">*
                                            </span>মামলা নম্বর</label>
                                        <input name="case_no" id="case_no" class="form-control form-control-sm" {{-- requireddd --}}
                                            value="{{ old('case_no') }}" />
                                        @error('case_no')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-lg-3 mb-5">
                                    <div class="form-group">
                                        <label>প্রতিষ্ঠান প্রতিনিধির নাম<span
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="defaulter_name" class="control-label"><span
                                                style="color:#FF0000">*
                                            </span>খাতকের নাম </label>
                                        <input   type="text" name="defaulter_name"
                                            id="defaulter_name" class="form-control form-control-sm">
                                        @error('defaulter_name')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
