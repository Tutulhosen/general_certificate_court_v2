                        ...
                        <ul class="navi navi-border navi-hover navi-active">
                            <li class="navi-item">
                                <a class="navi-link" href="#">
                                    ...
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2">জেনারেল সার্টিফিকেট অফিসারের আদালতে বিচারাধীন মামলা</span>
                                    </div>
                            ...
                            <li class="navi-item">
                                <a class="navi-link" href="#">
                                    <span class="navi-icon"><i class="fas fa-gavel icon-lg text-danger mr-3"></i></span>
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2">অতিরিক্ত জেলা প্রশাসক (রাজস্ব) এর আদালতে বিচারাধীন আপীল মামলা</span>
                                    </div>
                                    <span class="navi-label">
                            ...
                            <li class="navi-item">
                                <a class="navi-link" href="#">
                                    <span class="navi-icon"><i class="fas fa-gavel icon-lg text-danger mr-3"></i></span>
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2">অতিরিক্ত বিভাগীয় কমিশনার (রাজস্ব) এর আদালতে বিচারাধীন আপীল মামলা</span>
                                    </div>
                                    <span class="navi-label">
                            ...
                            <li class="navi-item">
                                <a class="navi-link" href="#">
                                    <span class="navi-icon"><i class="fas fa-gavel icon-lg text-danger mr-3"></i></span>
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2">সার্টিফিকেট অফিসারের আদালতে গ্রহনের জন্য অপেক্ষমান রিকুইজিশন</span>
                                    </div>
                                    <span class="navi-label">
                            ...
                            <li class="navi-item">
                                <a class="navi-link" href="#">
                                    <span class="navi-icon"><i class="fas fa-gavel icon-lg text-danger mr-3"></i></span>
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2">সার্টিফিকেট সহকারীর গ্রহনের জন্য অপেক্ষমান রিকুইজিশন</span>
                                    </div>
                                    <span class="navi-label">
                            ...
                            <li class="navi-item">
                                <a class="navi-link" href="#">
                                    <span class="navi-icon"><i class="fas fa-gavel icon-lg text-danger mr-3"></i></span>
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2" >অতিরিক্ত বিভাগীয় কমিশনার (রাজস্ব) এর আদালতে নিষ্পত্তিকৃত আপীল মামলা</span>
                                    </div>
                                    <span class="navi-label">
                            ...
                            <li class="navi-item">
                                <a class="navi-link" href="#">
                                    <span class="navi-icon"><i class="fas fa-gavel icon-lg text-danger mr-3"></i></span>
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2" >অতিরিক্ত জেলা প্রশাসক (রাজস্ব) এর আদালতে নিষ্পত্তিকৃত আপীল মামলা</span>
                                    </div>
                                    <span class="navi-label">
                                        <span class="label label-xl label-danger h6" id="SEND_TO_DC">0</span>
                                    </span>
                          ...
                          {{--   <li class="list-group-item font-weight-bolder h6"><i
                            ...
                            <li class="navi-item">
                                <a class="navi-link" href="#">
                                    <span class="navi-icon"><i class="fas fa-gavel icon-lg text-danger mr-3"></i></span>
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2">জেনারেল সার্টিফিকেট আদালতে নিষ্পত্তিকৃত মোট মামলা</span>
                                    </div>
                                    <span class="navi-label">
