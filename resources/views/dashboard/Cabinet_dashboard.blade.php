...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-offset-9">
            ...
            <li>
                <a href="{{ url('/download/usermanual')}}">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item font-weight-bolder h6"> <i
                                    class="fas fa-gavel icon-lg text-danger mr-3"></i>জেনারেল সার্টিফিকেট অফিসারের আদালতে বিচারাধীন মামলা
                                <span class="label label-inline label-danger font-weight-bold float-right h6"
                                    id="ON_TRIAL">0</span>
                            </li>
                            <li class="list-group-item font-weight-bolder h6"><i
                                    class="fas fa-gavel icon-lg text-danger mr-3"></i>অতিরিক্ত জেলা প্রশাসক (রাজস্ব) এর আদালতে বিচারাধীন আপীল মামলা
                                <span class="label label-inline label-danger font-weight-bold float-right h6"
                                    id="ON_TRIAL_DC">0</span>
                            </li>
                            <li class="list-group-item "><i
                                    class="fas fa-gavel icon-lg text-danger mr-3"></i>
                                    <span class="font-weight-bolder h5">অতিরিক্ত বিভাগীয় কমিশনার (রাজস্ব) এর আদালতে বিচারাধীন আপীল &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;মামলা</span>
                                <span class="label label-inline label-danger font-weight-bold float-right h6"
                                    id="ON_TRIAL_DIV_COM">0</span>
                            </li>
                            <li class="list-group-item font-weight-bolder h6"><i
                                    class="fas fa-gavel icon-lg text-danger mr-3"></i>ভূমি আপীল বোর্ড চেয়ারম্যানের আদালতে বিচারাধীন আপীল মামলা
                                <span class="label label-inline label-danger font-weight-bold float-right h6"
                                    id="ON_TRIAL_LAB_CM">0</span>
                            </li>
                            <li class="list-group-item font-weight-bolder h6"><i
                                    class="fas fa-gavel icon-lg text-danger mr-3"></i>সার্টিফিকেট অফিসারের আদালতে গ্রহনের জন্য অপেক্ষমান রিকুইজিশন
                                <span class="label label-inline label-danger font-weight-bold float-right h6"
                                    id="SEND_TO_GCO">0</span>
                            </li>
                            <li class="list-group-item font-weight-bolder h6"><i
                                    class="fas fa-gavel icon-lg text-danger mr-3"></i>সার্টিফিকেট সহকারীর গ্রহনের জন্য অপেক্ষমান রিকুইজিশন
                                <span class="label label-inline label-danger font-weight-bold float-right h6"
                                    id="SEND_TO_ASST_GCO">0</span>
                            </li>
                            <li class="list-group-item font-weight-bolder h6"><i
                                    class="fas fa-gavel icon-lg text-danger mr-3"></i>ভূমি আপীল বোর্ড চেয়ারম্যানের আদালতে নিষ্পত্তিকৃত আপীল মামলা
                                <span class="label label-inline label-danger font-weight-bold float-right h6"
                            ...
                            <li class="list-group-item "><i
                                    class="fas fa-gavel icon-lg text-danger mr-3"></i>
                                    <span class="font-weight-bolder h5">অতিরিক্ত বিভাগীয় কমিশনার (রাজস্ব) এর আদালতে নিষ্পত্তিকৃত &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;আপীল মামলা</span>
                                <span class="label label-inline label-danger font-weight-bold float-right h6"
                                    id="SEND_TO_DIV_COM">0</span>
                            </li>
                            <li class="list-group-item font-weight-bolder h6"><i
                                    class="fas fa-gavel icon-lg text-danger mr-3"></i>অতিরিক্ত জেলা প্রশাসক (রাজস্ব) এর  আদালতে নিষ্পত্তিকৃত আপীল মামলা
                                <span class="label label-inline label-danger font-weight-bold float-right h6"
                                    id="SEND_TO_DC">0</span>
                            </li>
                            <li class="list-group-item font-weight-bolder h6"><i
                                    class="fas fa-gavel icon-lg text-danger mr-3"></i>জেনারেল সার্টিফিকেট আদালতে নিষ্পত্তিকৃত মোট মামলা
                                <span class="label label-inline label-danger font-weight-bold float-right h6"
                                    id="CLOSED">0</span>
                            </li>
                        </ul>
