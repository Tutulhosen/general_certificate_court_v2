...
@section('content')
    <div class="modal fade" id="gmexampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body gmModalBody">
...
@section('scripts')
   ...
   <script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var modal = document.getElementById('gmexampleModal');
      
      // Open the modal
    //   $(modal).modal('show');
  
      // Fetch the content of the route using AJAX
