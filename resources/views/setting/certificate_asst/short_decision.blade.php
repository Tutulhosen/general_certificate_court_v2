        ...
        <div class="card-header flex-wrap py-5">
            ...
            <div class="card-toolbar">
                <a href="{{ route('certificate_asst.short.decision.create') }}" class="btn btn-sm btn-primary font-weight-bolder">
                    <i class="la la-plus"></i>নতুন গৃহীত ব্যবস্থা এন্ট্রি
                </a>
            </div>
        </div>
        <div class="card-body">
                ...
                <div class="container">
                   <div class="row">
                      <div class="col-lg-3 mb-5">
                         <input type="text" name="search_short_order_name" class="w-100 form-control common_datepicker" placeholder="গৃহীত ব্যবস্থা" autocomplete="off">
                      </div>
            ...
            <table class="table table-hover mb-6 font-size-h6">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th scope="col">গৃহীত ব্যবস্থা</th>
