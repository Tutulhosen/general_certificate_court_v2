            ...
            <div class="contentForm" style="font-size: medium;">
                <div id="head">
                    ...
                    <p style="text-align: center;"> (১৯১৭ সালের রেকর্ড ম্যানুয়েলের ১২৯ নং বিধি ) &nbsp;<br><span>আদেশপত্র,
                            তারিখ
                            {{ en2bn($appealOrderLists['ordershit_start_date']) }} হইতে
                            {{ en2bn($appealOrderLists['ordershit_end_date']) }} পর্যন্ত ।</span> <br><span> উপজেলা/জেলা
                            :{{ $appealOrderLists['case_Upzilla'] }},
                            {{ $appealOrderLists['case_District'] }}
                            ।</span> <br><br><span style="float: left"> মামলার ধরন :সরকারি পাওনা আদায় আইন, ১৯১৩ এর ৫
                            ধারা</span><span style="float: right;"> মামলা নম্বর-&nbsp;
                            {{ en2bn($appealOrderLists['case_info']['case_no']) }}
                            /{{ en2bn($appealOrderLists['case_info']['manual_case_no']) }} </span></p>
                            ...
                            @if (!empty($appealOrderLists['shortoder_array_date']))
                                @foreach ($appealOrderLists['shortoder_array_date'] as $index => $singleorder)
                                    <tr>
                                        ...
                                        <td width="80%" valign="middle" align="left" style="padding: 10px">
                ...
                <div style="text-align: center; width: 100%">
                    <p style="margin-top: 15px;">আমাকে স্ক্যান করুন</p>
                    <div id="qr_code_show">
                        {!! QrCode::size(170)->generate($data_image_path) !!}
