                                ...
                                <div class="col-md-8">
                                    <div class="pb-lg-0 pb-5 pt-8">
                                        <a href="{{ route('applicant.login.registration') }}"
                                            ...
                                            wait-class="spinner spinner-right spinner-white pr-15"></i>প্রাতিষ্ঠানিক প্রতিনিধি / নাগরিক লগইন</a>
                                    </div>
                                    <div class="pb-lg-0 pb-5 pt-8">
                                        <a href="{{ route('nothi.v2.login') }}"
                                            class="text-center btn btn-success btn-block font-size-h6 px-8 py-4 my-3 mr-3"
                                            wait-class="spinner spinner-right spinner-white pr-15">জেনারেল সার্টিফিকেট কোর্ট লগইন</a>
                                    </div>
                                    <div class="pb-lg-0 pb-5 pt-8">
                                        <a href="{{ route('administrative.login.registration') }}"
                                            class="text-center btn btn-primary btn-block font-size-h6 px-8 py-4 my-3 mr-3"
                                            wait-class="spinner spinner-right spinner-white pr-15"></i>এডমিন লগইন</a>
                                    </div>
                                    <div class="pb-lg-0 pb-5 pt-8">
