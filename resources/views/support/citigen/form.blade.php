...
@section('content')
    ...
    <div class="card">
        <div class="p-5 m-5">
            ...
            <h3 class="text-center">আপনার সাপোর্ট ফর্ম osTicket | Support Ticketing System এ প্রদান করা হবে এবং পরবর্তী আপডেট <spna id="input_support_email">{{  isset(globalUserInfo()->email) ? globalUserInfo()->email : old('support_email') }}</spna> ইমেইল এ প্রদান করা হবে </h3>
