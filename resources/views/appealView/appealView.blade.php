   ...
   <div class="card-body">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        @if($appeal->case_entry_type=='RUNNING')
        <table class="table table-striped border">
            <thead>
                <th class="h3" scope="col" colspan="2">আদেশ নামা সংযুক্তি</th>
            </thead>
           <tbody>
              <tr>
                 <td>
                    @if($runningcommandList)
                          <div class="form-group mb-2" id="deleteFile{{ $runningcommandList->id }}">
                              <div class="input-group">
                                  <div class="input-group-prepend">
                                      
                                  </div>
                                 
                                  <input readonly type="text" class="form-control" value="{{ $runningcommandList->file_category ?? '' }}" />
                                  <div class="input-group-append">
                                      <a href="{{ asset($runningcommandList->file_path . $runningcommandList->file_name) }}" target="_blank" class="btn btn-sm btn-success font-size-h5 float-left">
                                          <i class="fa fas fa-file-pdf"></i>
                                          <b>দেখুন</b>
        ...
        <table class="table table-striped border">
            <thead>
                <th class="h3" scope="col" colspan="2">আদেশের টেমপ্লেট সংযুক্তি</th>
            </thead>
           <tbody>
              <tr>
                 <td>
                        @forelse ($runningorderTemplate as $key => $row)
                          <div class="form-group mb-2" id="deleteFile{{ $row->id }}">
                              <div class="input-group">
                                  <div class="input-group-prepend">
        ...
        <table class="table table-striped border">
            <thead>
                <th class="h3" scope="col" colspan="2">হাজিরা সংযুক্তি</th>
            </thead>
           <tbody>
              <tr>
                 <td>
                     @if($attendance_list)
                          <div class="form-group mb-2" id="deleteFile{{ $attendance_list->id }}">
                              <div class="input-group">
                                  <div class="input-group-prepend">
                                      
                                  </div>
                                 
                                  <input readonly type="text" class="form-control" value="{{ $attendance_list->file_category ?? '' }}" />
                                  <div class="input-group-append">
                                      <a href="{{ asset($attendance_list->file_path . $attendance_list->file_name) }}" target="_blank" class="btn btn-sm btn-success font-size-h5 float-left">
                                          <i class="fa fas fa-file-pdf"></i>
                                          <b>দেখুন</b>
