                ...
                <div class="mb-12">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6" style="margin-top:20px;">
                            ...
                            <?php 
                                $central_data=DB::table('parent_office')->where('organization_type', $organization->organization_type)->get();

                            ?>

                            @if (!empty($central_data))
                            <option value=" " >--নির্বাচন করুন--</option>
                                @foreach ($central_data as $item)
                                    <?php
                                        if ($organization->parent==$item->id) {
                                    ...
                                    ?>
                                    <option value="{{$item->id}}" {{$selected}}>{{$item->name_bn}}</option>
                                @endforeach
                            @endif
                        ...
                        <div class="col-lg-12" style="margin-top:20px;">
                            <label>প্রাতিষ্ঠানের আইডি (রাউটিং নং ) ( ইংরেজি ) <span class="text-danger">*</span></label>
