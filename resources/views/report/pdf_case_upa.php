	...
	<div class="priview-body">
        ...
        <div class="row">
                <div class="col-3 text-left float-left" style="border: 0px solid red; font-size:small;text-align:left;">
                    <?= en2bn(date('d-m-Y')) ?><br><br><br>
                    বিভাগঃ <?=user_office_info()->div_name_bn?> ।<br>
                    জেলাঃ <?=user_office_info()->dis_name_bn?> ।
                </div>
            ...
            <table class="table table-hover table-bordered report">
                <thead class="headding">
                    <tr>
                        ...
                        <th class="text-center">জেনারেল সার্টিফিকেট আদালতে বিচারাধীন মামলা</th>
                ...
                <tbody>
                    <?php
                    $i = $grandTotal = 0;
                    $RUNNING_CASE_AT_GCO=$RUNNING_APPEAL_CASE_AT_ADC=$PANDING_CASE_AT_GCO=$PANDING_CASE_AT_ASST_GCO=$CLOSED_APPEAL_CASE_AT_ADC=$CLOSED_CASE_AT_GCC=0;
