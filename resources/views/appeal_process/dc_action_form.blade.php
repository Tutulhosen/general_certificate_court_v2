    ...
    <div class="col-xl-12 col-xxl-7">
        ...
        <form id="" action="" class="form" method="POST">
            ...
            <div class="" style=" text-align:center; font-weight:bold; color:black">
                <div class="">
                    <h1 >আবেদনটি রেকর্ডরুম ডেপুটি কালেক্টর বরাবর প্রেরণ </h1>
                </div>
            </div>
            <fieldset class="pb-5 create_cause" data-wizard-type="step-content-2"
                ...
                <?php 
                    $order='জনাব (রেকর্ডরুম ডেপুটি কালেক্টর), 
এই মামলার সার্টিফিকেট কপির প্রক্রিয়া করনের পরবর্তী পদক্ষেপ নেওয়ার জন্য আপনাকে নির্দেশ প্রদান করা হল ।'
                ?>
...
<script>
         ...
         $(document).on('click', '#next_btn', function(){
            ...
            Swal.fire({
                ...
                text: "রেকর্ডরুম ডেপুটি কালেক্টর বরাবর প্রেরণ।",
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{route('appeal.sent.to.deputy.collector')}}",
                        type: "POST",
                        data:{
                            appeal_id:appeal_id,
