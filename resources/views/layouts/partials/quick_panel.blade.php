            ...
            <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                ...
                <div class="mb-15 d-none">
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        <div class="symbol symbol-50 symbol-light mr-5">
                            <span class="symbol-label">
                                <img src="{{ asset('media/svg/misc/014-kickstarter.svg') }}"
                ...
                <div class="mb-5">
                    ...
                    @forelse ($case_status as $row)
                        <div class="d-flex align-items-center bg-light-success rounded p-5 mb-5">
                            ...
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                                <a href="{{ route('action.receive', $row->cs_id) }}"
                                    class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">{{ $row->status_name }}</a>
                            </div>
                            <span
                                class="font-weight-bolder py-1 bg-danger text-white label">{{ $row->total_case }}</span>
                        </div>
                    @empty
                        <div class="d-flex align-items-center bg-light-success rounded p-5 mb-5">
